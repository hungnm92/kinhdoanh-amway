...
<script type='text/javascript' src="../js/jquery-ui-1-8-23.js"></script>
    ...
    <div id="popup">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NgayKyThe" HeaderText="     Ngày ký thẻ      " DataFormatString=" {0:dd/MM/yyyy}"></asp:BoundField>
...
"^([0-9a-zA-Z_\-~ :\\])+(.jpg|.JPG|.jpeg|.JPEG|.bmp|.BMP|.gif|.GIF|.png|.PNG)$"> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CalendarExtender ID="CalendarExtender1" TargetControlID="txtNgaySinh" Format="dd/MM/yyyy" runat="server">
...
TargetControlID="txtSoDT" >
            ...
            <tr>
                ...
                <td >Ngày ký thẻ:&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="txtNgayKyThe" Format="dd/MM/yyyy" runat="server">
                    </asp:CalendarExtender>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:CalendarExtender ID="CalendarExtender3" TargetControlID="txtNgayHetHan" Format="dd/MM/yyyy" runat="server">
                    </asp:CalendarExtender>
                </td>
