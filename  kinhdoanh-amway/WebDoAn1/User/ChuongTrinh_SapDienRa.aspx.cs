...
public partial class User_ChuongTrinh_SapDienRa : System.Web.UI.Page
{
    ...
    protected void griChuongTrinhSapDienRa_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        lblTB.Visible = false;
        ct.MaCT = int.Parse(griChuongTrinhSapDienRa.SelectedValue.ToString());
        ct.CT();
    ...
    protected void btnChamSoc_Click(object sender, EventArgs e)
    {
            ...
            cs.MaCT = int.Parse(griChuongTrinhSapDienRa.SelectedValue.ToString());
    ...
    {
        dt.MaCT = int.Parse(griChuongTrinhSapDienRa.SelectedValue.ToString());
