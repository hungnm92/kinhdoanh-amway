...
"^([0-9a-zA-Z_\-~ :\\])+(.jpg|.JPG|.jpeg|.JPEG|.bmp|.BMP|.gif|.GIF|.png|.PNG)$"> 
            ...
            <tr>
                <td class="auto-style9" colspan="2">Địa chỉ thường trú:&nbsp;<asp:TextBox ID="txtSoNhaKHTT" runat="server"></asp:TextBox>
                    ...
                    <asp:DropDownList ID="droHuyenKHTT" runat="server" DataTextField="TenHuyen" DataValueField="MaHuyen" OnSelectedIndexChanged="droHuyenKHTT_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:DropDownList ID="droTinhKHTT" runat="server" DataTextField="TenTinh" DataValueField="MaTinh" OnSelectedIndexChanged="droTinhKHTT_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="auto-style13" colspan="2">Địa chỉ liên lạc:
                    ...
                    <asp:DropDownList ID="droHuyenKHLL" runat="server" DataTextField="TenHuyen" DataValueField="MaHuyen" OnSelectedIndexChanged="droHuyenKHLL_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:DropDownList ID="droTinhKHLL" runat="server" DataTextField="TenTinh" DataValueField="MaTinh" OnSelectedIndexChanged="droTinhKHLL_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
