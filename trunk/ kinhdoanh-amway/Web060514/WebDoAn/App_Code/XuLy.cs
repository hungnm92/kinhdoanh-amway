    ...
    public class Menu
    {
        ...
        public string LoadMenu(string MaNBT, int level)
        {
            ...
            else
            {
                ...
                {
                    KetQua += "<li><a class = 'button' onclick =" + DocDL["ngoac"].ToString() + "javascript:setSession('" + DocDL["MaNPP"].ToString() + "');" + DocDL["ngoac"].ToString() + "><img src='" + "../src/web/emp/" + DocDL["AnhCD"] + "'><span>" + DocDL["HoTenNPP"] + "</span>";//Hiển thị họ tên, lấy MaNPP và chạy hàm Js khi click.
