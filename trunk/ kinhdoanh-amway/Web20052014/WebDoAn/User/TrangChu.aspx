...
TargetControlID="txtSoDT" ></asp:FilteredTextBoxExtender>
            ...
            <tr>
                <td class="auto-style5" colspan="2">Địa chỉ thường trú:
                    ...
                    <asp:DropDownList ID="droHuyenNPPTT" runat="server" DataValueField="MaHuyen" DataTextField="TenHuyen" OnSelectedIndexChanged="droHuyenNPPTT_SelectedIndexChanged">
                    </asp:DropDownList>
