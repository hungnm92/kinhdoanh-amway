...
namespace webdoan
{
    ...
    public class Huyen
    {
        ...
        public DataTable DS_TheoTinh(string MaTinh)
        {
            string SelectSQL = "SELECT MaHuyen, TenHuyen FROM Tinh, Huyen	Where Huyen.MaTinh = Tinh.MaTinh AND Huyen.MaTinh = @MaTinh";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
            {
                ...
                Lenh.Parameters.Add("@MaTinh", SqlDbType.Int).Value = MaTinh;
    ...
    public class CapDo
    {
        ...
        public string AnhCD;
        public DataTable DS(int MaCD)
        {
            string SelectSQL = "SELECT MaCD, TenCD, NoiDung, AnhCD FROM CapDo WHERE MaCD >= @MaCD";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
    ...
    public class NhaPhanPhoi
        {
            ...
            public bool DangNhap()
            {
                try
                {
                    ...
                    if (DocDL.Read() == true)
                    {
                        ...
                        NgayHetHan = DocDL["NgayHetHan"].ToString();
            ...
            {
                string SelectSQL = "SELECT distinct NPP.MaNPP,HoNPP +' '+ TenNPP AS HoTenNPP,NgaySinh,GioiTinh,AnhNPP,CMND,SoDT,Email,MatKhau,NgayKyThe, NgayHetHan,SoNhaNPPTT+' '+DTT.TenDuong+' '+XTT.TenXa+' '+ HTT.TenHuyen+' '+ TTT.TenTinh AS DiaChiTT, SoNhaNPPLL+' '+DLL.TenDuong+' '+XLL.TenXa+' '+ HLL.TenHuyen+' '+ TLL.TenTinh AS DiaChiLL,MaDuongNPPLL, MaDuongNPPTT, MaXaNPPLL, MaXaNPPTT, MaNBT, XTT.MaHuyen AS MaHuyenNPPTT, HTT.MaTinh AS MaTinhNPPTT,XLL.MaHuyen AS MaHuyenNPPLL, HLL.MaTinh AS MaTinhNPPLL, CapDo.TenCD, CD.MaCD FROM NhaPhanPhoi NPP, XaPhuong as XLL, XaPhuong as XTT, Duong as DLL, Duong as DTT, Huyen HLL, Huyen HTT, Tinh TLL, Tinh TTT, (SELECT distinct QTCD.MaNPP, max(MaCD) as MaCD FROM QuaTrinhCD QTCD, NhaPhanPhoi NPP  where NPP.MaNBT = @MaNPP AND NPP.MaNPP = QTCD.MaNPP group by QTCD.MaNPP) as CD, CapDo WHERE NPP.MaXaNPPLL = XLL.MaXa AND NPP.MaXaNPPTT = XTT.MaXa AND NPP.MaDuongNPPLL = DLL.MaDuong AND NPP.MaDuongNPPTT = DTT.MaDuong	AND XLL.MaHuyen = HLL.MaHuyen AND XTT.MaHuyen = HTT.MaHuyen AND HLL.MaTinh = TLL.MaTinh AND HTT.MaTinh = TTT.MaTinh AND MaNBT = @MaNPP AND CD.MaCD = @MaCD AND CD.MaCD = CapDo.MaCD AND NPP.MaNPP = CD.MaNPP ORDER BY NgayKyThe DESC";
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                DataTable ThungChua = new DataTable();
                BaoVe.Open();
                if (BaoVe.State == ConnectionState.Open)
            ...
            public void Tim_MaNPP()
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_Tim_MaNPP", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@CMND", CMND);
                SqlDataReader DocDL;
            ...
            public DataTable TimTheoTen()//su dung ky thuat lay danh sach co tham so truyen vao
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_SL_CanhBao", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@NgayHetHan",NgayHetHan);
                DataTable ThungChua = new DataTable();
                SqlDataReader DocDL;
                BaoVe.Open();//mở kết nối đến CSDL
                DocDL = Lenh.ExecuteReader(CommandBehavior.CloseConnection);
            ...
            public void Sua_NgayHetHan()
            {
                ...
                {
                    SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                    SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_Sua_NgayHetHan", BaoVe);
                    Lenh.CommandType = CommandType.StoredProcedure;
                    SqlParameter ThamSo = new SqlParameter();
                    ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                    ThamSo = Lenh.Parameters.AddWithValue("@NgayHetHan", NgayHetHan);
            ...
            public void CanhBao()
            {
                ...
                {
                    SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                    SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_CanhBao", BaoVe);
                    Lenh.CommandType = CommandType.StoredProcedure;
                    SqlParameter ThamSo = new SqlParameter();
                    ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                    ThamSo = Lenh.Parameters.AddWithValue("@NgayHetHan", NgayHetHan);
    ...
    public class QuaTrinhCD
    {
        ...
        public void Them()
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("QuaTrinhCD_Them", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
        ...
        public void Xoa()
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("QuaTrinhCD_Xoa", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaCD", MaCD);
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
        ...
        public void Sua()
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("QuaTrinhCD_Sua", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaCD", MaCD);
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
        ...
        public DataTable DS(string MaNPP)
        {
            string SelectSQL = "SELECT QTCD.MaCD,TenCD, ThoiGian FROM QuaTrinhCD QTCD, CapDo CD	WHERE MaNPP = @MaNPP AND QTCD.MaCD = CD.MaCD";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        public void Xoa_DS()
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("QuaTrinhCD_Xoa_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                BaoVe.Open();
    ...
    public class ChamSoc
    {
        ...
        public void Them()
        {
            try
            {
                ...
                ThamSo = Lenh.Parameters.AddWithValue("@NgayCS", NgayCS);
                ThamSo = Lenh.Parameters.AddWithValue("@MaCT", MaCT);
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                BaoVe.Open();
        ...
        {
            string SelectSQL = "SELECT MaCS, NgayCS, SoLan,ThamDu,CS.MaCT, TenCT FROM ChamSoc CS,ChuongTrinh CT WHERE MaNPP = @MaNPP AND MaKH = @MaKH AND CS.MaCT = CT.MaCT";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        {
            string SelectSQL = "SELECT MaCS, NgayCS, SoLan,ThamDu, MaCT, MaKH, MaNPP FROM ChamSoc CS WHERE CS.MaKH = @MaKH";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        public DataTable DS_NPP(string MaNPP)
        {
            string SelectSQL = "SELECT MaCS, NgayCS, SoLan,ThamDu, CS.MaCT, TenCT, CS.MaKH, HoKH +' '+TenKH AS HoTenKH FROM ChamSoc CS, KhachHang KH, ChuongTrinh CT WHERE CS.MaNPP = @MaNPP AND CS.MaKH = KH.MaKH AND CS.MaCT = CT.MaCT";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
    ...
    public class DaoTao
    {
        ...
        public void Them()
        {
            try
            {
                ...
                ThamSo = Lenh.Parameters.AddWithValue("@MaCT", MaCT);
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@NgayDT", NgayDT);
                BaoVe.Open();
                Lenh.ExecuteNonQuery();
                BaoVe.Close();
                ThongBao = "Thêm thành công!.";
        ...
        public void Xoa()
        {
            try
            {
                ...
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaDT", MaDT);
                BaoVe.Open();
                Lenh.ExecuteNonQuery();
                BaoVe.Close();
                ThongBao = "Xóa thành công!.";
        ...
        public void CT()
        {
            ...
            if (DocDL.Read() == true)
            {
                MaDT = DocDL["MaDT"].ToString();
                NgayDT = DocDL["NgayDT"].ToString();
                SoLan = int.Parse(DocDL["SoLan"].ToString());
                MaCT = DocDL["MaCT"].ToString();
                TenCT = DocDL["TenCT"].ToString();
            }
        ...
        public DataTable DS(string MaNPP)
        {
            string SelectSQL = "SELECT MaDT, NgayDT, CT.MaCT,TenCT, SoLan FROM DaoTao DT, ChuongTrinh CT WHERE MaNPP = @MaNPP AND DT.MaCT = CT.MaCT";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
    ...
    public class NPPSuDung
    {
        ...
        public void Them()
        {
            try
            {
                ...
                ThamSo = Lenh.Parameters.AddWithValue("@NgayNPPSDHH", NgayNPPSDHH);
                ThamSo = Lenh.Parameters.AddWithValue("@GhiChu", GhiChu);
                BaoVe.Open();
                Lenh.ExecuteNonQuery();
                BaoVe.Close();
                ThongBao = "Thêm thành công!.";
        ...
        public DataTable DS(string MaNPP)
        {
            string SelectSQL = "SELECT MaNPPSD, NgayNPPSD, NgayNPPSDHH, GhiChu, SoLuong, MinhHoa, NPPSuDung.MaMH, TenMH FROM NPPSuDung ,MatHang MH WHERE MaNPP = @MaNPP AND NPPSuDung.MaMH = MH.MaMH";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        {
            string SelectSQL = "SELECT MH.MaMH, MH.MaLMH, TenMH, TenLMH, ChiTiet, CachSuDung, AnhMH, Gia, SoLuong, Minhhoa, NPPSuDung.MaNPPSD, NgayNPPSD, NgayNPPSDHH, GhiChu FROM MatHang MH, LoaiMH LMH, NPPSuDung WHERE MH.MaLMH = LMH.MaLMH AND NPPSuDung.MaMH = MH.MaMH AND NPPSuDung.MaNPP = @MaNPP";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        {
            string SelectSQL = "SELECT DISTINCT MH.MaMH, MH.MaLMH, TenMH, TenLMH, ChiTiet, CachSuDung, AnhMH, Gia FROM MatHang MH, LoaiMH LMH WHERE MH.MaLMH = LMH.MaLMH AND MH.MaMH not in (SELECT MH.MaMH	FROM MatHang MH, LoaiMH LMH, NPPSuDung	WHERE MH.MaLMH = LMH.MaLMH AND NPPSuDung.MaMH = MH.MaMH AND NPPSuDung.MaNPP = @MaNPP)";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
    ...
    public class KHSuDung
    {
        ...
        public void Them()
        {
            try
            {
                ...
                ThamSo = Lenh.Parameters.AddWithValue("@NgayKHSDHH", NgayKHSDHH);
                ThamSo = Lenh.Parameters.AddWithValue("@GhiChu", GhiChu);
                ThamSo = Lenh.Parameters.AddWithValue("@SoLuong", SoLuong);
                ThamSo = Lenh.Parameters.AddWithValue("@MinhHoa", MinhHoa);
                BaoVe.Open();
        ...
        public DataTable DS(string MaNPP, string MaKH)
        {
            string SelectSQL = "SELECT MaKHSD, NgayKHSD, NgayKHSDHH, SoLuong, MinhHoa, KHSuDung.MaMH, TenMH, GhiChu FROM KHSuDung ,MatHang MH WHERE MaNPP = @MaNPP AND MaKH = @MaKH AND KHSuDung.MaMH = MH.MaMH";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        {
            string SelectSQL = "SELECT DISTINCT MH.MaMH, MH.MaLMH, TenMH, TenLMH, ChiTiet, CachSuDung, AnhMH, Gia FROM MatHang MH, LoaiMH LMH WHERE MH.MaLMH = LMH.MaLMH AND MH.MaMH not in (SELECT KHSuDung.MaMH FROM MatHang MH, LoaiMH LMH, KHSuDung WHERE MH.MaLMH = LMH.MaLMH AND KHSuDung.MaMH = MH.MaMH AND KHSuDung.MaKH = @MaKH AND KHSuDung.MaNPP = @MaNPP)";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn   ");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        {
            string SelectSQL = "SELECT MH.MaMH, MH.MaLMH, TenMH, TenLMH, ChiTiet, CachSuDung, AnhMH, Gia, SoLuong, MinhHoa,KHSuDung.MaKHSD, NgayKHSD, NgayKHSDHH, GhiChu FROM MatHang MH, LoaiMH LMH, KHSuDung WHERE MH.MaLMH = LMH.MaLMH AND KHSuDung.MaMH = MH.MaMH AND KHSuDung.MaKH = @MaKH AND KHSuDung.MaNPP = @MaNPP";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
        ...
        public DataTable DS_KH(string MaKH)
        {
            string SelectSQL = "SELECT MaKHSD, NgayKHSD, NgayKHSDHH, SoLuong, MinhHoa, MaMH, GhiChu FROM KHSuDung WHERE KHSuDung.MaKH = @MaKH";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
            if (BaoVe.State == ConnectionState.Open)
