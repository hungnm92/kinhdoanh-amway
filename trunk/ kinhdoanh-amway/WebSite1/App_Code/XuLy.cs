...
namespace webdoan
{
    ...
    public class Huyen
    {
        ...
        {
            string SelectSQL = "SELECT MaHuyen, TenHuyen FROM Huyen, Tinh Where Tinh.MaTinh = Huyen.MaTinh AND Huyen.MaTinh = @MaTinh";
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
            DataTable ThungChua = new DataTable();
            BaoVe.Open();
    ...
    public class CapDo
    {
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("CapDo_DS", BaoVe);
    ...
    public class KhachHang
    {
        ...
        public DataTable KhachHang_DS_TheoLoai(string MaNPP, bool Loai)
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("KhachHang_DS_TheoLoai", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@Loai", Loai);
    ...
    public class NhaPhanPhoi
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_DS_TheoCapDo", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@MaCD", MaCD);
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("SL_NhaPhanPhoi", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNBT", MaNBT);
                DataTable ThungChua = new DataTable();
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_DS_ThanhTichMoi", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
            ...
            public DataTable DS_Moi()//su dung ky thuat lay danh sach co tham so truyen vao
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NhaPhanPhoi_DS_Moi", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@TuNgay", TuNgay);
            ...
            public DataTable TrungTamPP_DS_GoogleMap()//su dung ky thuat lay danh sach co tham so truyen vao
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("TrungTamPP_DS_GoogleMap", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                DataTable ThungChua = new DataTable();
                SqlDataReader DocDL;
                BaoVe.Open();//mở kết nối đến CSDL
    ...
    public class DoanhThu
        {
            ...
            {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("DoanhThu_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                DataTable ThungChua = new DataTable();
    ...
    public class QuaTrinhCD
    {
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("QuaTrinhCD_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                DataTable ThungChua = new DataTable();
    ...
    public class ChamSoc
    {
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("ChamSoc_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
        ...
        public string DS_KH(string MaKH)
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("ChamSoc_DS_KH", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
                DataTable ThungChua = new DataTable();
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("SL_ChamSoc", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
                DataTable ThungChua = new DataTable();
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("ChamSoc_DS_NPP", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                DataTable ThungChua = new DataTable();
    ...
    public class DaoTao
    {
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("DaoTao_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                DataTable ThungChua = new DataTable();
    ...
    public class NPPSuDung
    {
        ...
        {
            SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("NPPSuDung_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                DataTable ThungChua = new DataTable();
    ...
    public class KHSuDung
    {
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("KHSuDung_DS", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaNPP", MaNPP);
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("SL_KHSuDung", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
                DataTable ThungChua = new DataTable();
        ...
        {
                SqlConnection BaoVe = new SqlConnection("server=(local)\\SQLEXPRESS;uid=sa;pwd=123456;database=DoAn");
                SqlCommand Lenh = new SqlCommand("KHSuDung_DS_KH", BaoVe);
                Lenh.CommandType = CommandType.StoredProcedure;
                SqlParameter ThamSo = new SqlParameter();
                ThamSo = Lenh.Parameters.AddWithValue("@MaKH", MaKH);
                DataTable ThungChua = new DataTable();
